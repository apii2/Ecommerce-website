...
export default function Header() {
  ...
  return (
    <nav className="h-[5.5rem]">
      <div className="flex items-center justify-between fixed top-0 z-30 px-4 xs:px-8 lg:px-24 xl:px-30 py-5 w-full bg-white/96 shadow-lg">
